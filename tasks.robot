...
Download And Begin
    ...
    Download    ${secret}[RPA_Secret_file]        overwrite=True
...
Take Robot Screenshot
    ...
    Sleep    1sec
    Capture Element Screenshot    ${imgSelector}    ${output_folder}${/}roboImage.png
...
Create Zip File    
    Archive Folder With ZIP     ${output_folder}  ZipFile.zip   recursive=True  include=*.pdf
